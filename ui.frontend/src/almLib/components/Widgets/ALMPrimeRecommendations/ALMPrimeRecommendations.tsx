...
import { PrimeEvent, Widget, WidgetType } from '../../../utils/widgets/common';
...
const ALMPrimeRecommendations: React.FC<{
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      updateSkipLinks(configuresStrips as Widget[]);
  ...
  const updateSkipLinks = (recommendationsStripList: Widget[]) => {
    PrimeDispatchEvent(document, PrimeEvent.WIDGETS_TO_RENDER, false, {
      recommendationsStripList,
    });
  };
