...
public class ConfigurationColumnViewItemTest {
  ...
  public void testGetTitle() {
    ...
    ConfigurationColumnViewItem columnViewItem =
        context.request().adaptTo(ConfigurationColumnViewItem.class);
    Assert.assertEquals(
        "Returns the correct title", "adobe-learning-manager-config", columnViewItem.getTitle());
  }
  ...
  public void testGetQuickActionsForFolderWithConfiguration() {
    ...
    String[] expectedActions = new String[] {CREATE_PULLDOWN_ACTIVATOR, CREATE_FOLDER_ACTIVATOR};
  ...
  public void testGetQuickActionsForFolderWithoutConfigurationAndWithFolder() {
    ...
    String[] expectedActions =
        new String[] {
          CREATE_PULLDOWN_ACTIVATOR, CREATE_FOLDER_ACTIVATOR,
        };
  ...
  public void testGetQuickActionsForConfigurations() {
    ...
    String[] expectedActions =
        new String[] {
          PROPERTIES_ACTIVATOR, PUBLISH_ACTIVATOR, UNPUBLISH_ACTIVATOR, DELETE_ACTIVATOR
        };
