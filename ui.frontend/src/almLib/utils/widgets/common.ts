...
export const INSTANCE_CARD_WIDTH = 328;
export const ZERO = 0;
export const ONE = 1;
export const MIN_COLUMN_WIDTH_FOR_2_CARDS = 556;
...
export enum PrimeEvent {
  ...
  ALM_LO_FEEDBACK_DATA = 'ALM_LO_FEEDBACK_DATA',
  ...
  ALM_RESIZE_STRIP = 'ALM_RESIZE_STRIP',
  ALM_REMOVE_EXTENSION_RESPONSE_TOKEN = 'ALM_REMOVE_EXTENSION_RESPONSE_TOKEN',
  ALM_RELOAD_SKILL_FRAME = 'ALM_RELOAD_SKILL_FRAME',
  ALM_UNMOUNT_EXTERNAL_SKILL_GRAPH = 'ALM_UNMOUNT_EXTERNAL_SKILL_GRAPH',
  ALM_RELOAD_PRL_FRAME = 'ALM_RELOAD_PRL_FRAME',
  ALM_HIDE_FOOTER = 'ALM_HIDE_FOOTER',
  ALM_TRAININGS_LOADED = 'ALM_TRAININGS_LOADED',
  ALM_PAGE_TITLE_UPDATE = 'ALM_PAGE_TITLE_UPDATE',
  ALM_EB_GET_CONFIG = 'ALM_EB_GET_CONFIG',
  ALM_EB_SENT_CONFIG = 'ALM_EB_SENT_CONFIG',
  ALM_EB_NAVIGATE = 'ALM_EB_NAVIGATE',
}
...
export const enum WidgetType {
  ...
  RECOMMENDATIONS = 'com.adobe.captivateprime.recommendations',
  RECOMMENDATIONS_STRIP = 'com.adobe.captivateprime.lostrip.reco',
  DISCOVERY_RECO = 'com.adobe.captivateprime.lostrip.discovery',
  CATEGORY = 'com.adobe.captivateprime.category',
  COURSES_AND_PATHS = 'com.adobe.captivateprime.courses.and.paths',
  HTML_WIDGET = 'com.adobe.captivateprime.html',
...
export const WIDGET_REF_TO_TYPE = {
  ...
  'com.adobe.captivateprime.category': WidgetTypeNew.CATEGORY,
  'com.adobe.captivateprime.courses.and.paths': WidgetTypeNew.COURSES_AND_PATHS,
