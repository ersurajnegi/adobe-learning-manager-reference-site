...
function setCatalogParams(widget: any, params: any) {
  ...
  const learnerState = widget.attributes?.learnerState || ['enrolled', 'started', 'notenrolled'];
...
const getApiOptions = async (query: string, widget: Widget) => {
  ...
  params['include'] = ['learningObject.instances', 'learningObject.skills.skillLevel.skill'];
  ...
  switch (widget.widgetRef) {
    case WidgetType.BOOKMARKS:
      params['include'] = ['enrollment', 'skills.skillLevel.skill', 'instances.enrollment'];
    ...
    case WidgetType.CATALOG:
      setCatalogParams(widget, params);
      params['include'] = ['enrollment', 'skills.skillLevel.skill', 'instances.enrollment'];
      endpoint = loEndPoint;
      break;
    ...
    case WidgetType.CATALOG_BROWSER:
      setCatalogParams(widget, params);
      endpoint = '/catalogs';
      params['include'] = ['enrollment', 'instances.enrollment', 'skills.skillLevel.skill'];
    ...
    case WidgetType.SEARCH:
      ...
      if (query) {
        ...
        params['include'] = ['enrollment', 'instances', 'skills.skillLevel.skill'];
        params['sort'] = '-date';
        endpoint = loEndPoint;
      }
      break;
    ...
    case WidgetType.RECOMMENDATIONS_STRIP:
      ...
      if (account.recommendationAccountType != CPENEW || account.prlCriteria?.enabled) {
        ...
        params['include'] = 'instances,skills.skillLevel.skill';
      }
      method = 'POST';
      break;
